...
/**
 * membuat menu generator dab disimpan ke database
 * database tersedia untuk migrate di .../widget/ltenav/migration_LTE
 */
class LteNavEdit extends Widget
{
